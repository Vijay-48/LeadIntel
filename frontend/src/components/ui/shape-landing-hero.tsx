                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible">
                        <button
                            ...
                            className="group relative inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-indigo-500 to-rose-500 rounded-full text-white font-semibold text-lg hover:shadow-[0_0_40px_rgba(99,102,241,0.5)] transition-all duration-300 hover:scale-105"
                        >
